...
class medicationSkill(MycroftSkill):
    ...
    #I took my medication cue
    @intent_handler(IntentBuilder("").require("Took").require("Medication"))
    def handle_took_medication_intent(self, message):
        # In this case, respond by simply speaking a canned response.
        # Mycroft will randomly speak one of the lines from the file
        #    dialogs/en-us/hello.world.dialog
        self.speak_dialog("medication")
    ...
    @intent_handler(IntentBuilder("").require("Did").require("Take").require("Medication"))
    def handle_was_taken_medication(self, message):
	...
	if (int(dayFed) == int(time_now.strftime("%d"))) and (monthFed == time_now.strftime("%B")):
		self.speak("yes you took your medication today")
	else:
		self.speak("no you did not take your medication today")
